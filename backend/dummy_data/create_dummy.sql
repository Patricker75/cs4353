...
BEGIN
	...
	INSERT INTO fuel_request(user_id, amount, total_price, delivery_date)
	VALUES (user_id_1, 1001, 1741.74, '2023-12-31');
	
	INSERT INTO fuel_request(user_id, amount, total_price, delivery_date)
	VALUES (user_id_2, 2000, 3510, '2024-01-01');
	
	INSERT INTO fuel_request(user_id, amount, total_price, delivery_date)
	VALUES (user_id_3, 5000, 8700, '2024-01-02');
	
	INSERT INTO fuel_request(user_id, amount, total_price, delivery_date)
	VALUES (user_id_3, 5000, 8625, '2024-02-01');
END $$