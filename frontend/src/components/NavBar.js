  ...
  return (
    shouldShowNavBar && (
      <nav style={navbarStyle}>
        <NavLink to='/' style={{ ...navLinkStyle, paddingLeft: '0' }}>Home</NavLink>
        <NavLink to='/profile' style={navLinkStyle}>Your Profile</NavLink>
        <NavLink to='/fuel' style={navLinkStyle}>Fuel Request Form</NavLink>
        <NavLink to='/display' style={navLinkStyle}>Fuel Request History</NavLink>
      </nav>
    )
  );
};
